"""
Sensor definitions for code location 1.
This location manages sensors 0-9 (10 sensors total).
"""
...
# This location handles sensors 0-9
...
location_1_sensors = generate_location_sensors()
